...
public class ListaLigada<T> {
    ...
    public void add( T dato){
        ...
        if (head == null){//La lista esta vacia, creamos el primer nodo
            ...
            actual.setSiguiente(nuevoNodo);//Actual.sig apunta al nuevoNodo(enlase entre nodos)
            actual=nuevoNodo;//ahora actual en el nuevoNodo 
    ...
    public void printList(){
        ...
        while(actual != null){
            ...
            System.out.println("Dato = " + elemento +" almacenado nodo : " + posicion);
            actual = actual.getSiguiente();
            posicion++;
